...
VALUES
  ('Париж, Франция", "Город света известен своей потрясающей архитектурой, художественными музеями и романтической атмосферой. Посетите такие знаковые достопримечательности, как Эйфелева башня, Лувр и собор Парижской Богоматери.', 'https://images.pexels.com/photos/699466/pexels-photo-699466.jpeg?auto=compress&cs=tinysrgb&w=1600', 'Европа', 48.8566, 2.3522, 4.7),
